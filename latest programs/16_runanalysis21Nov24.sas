...
data dsn; set dsn; if time eq . then delete; 
    /* *added for reviewer responses November 20 2025: Median time between first and second prescription */
...
/* *added for reviewer responses November 25, 2025: Median time between first and second prescription */
...
data mediantimetmp(rename=(sum=time_sum)); 
    /* November 25, 2025 addition of mediantimebetweenrx */
