...
- Table 1 for Abrahami et. al (check code and why population moves nonintuitively)
- Table 1 in main manuscript and untrimmed cohort in the appendix
...
- Will add analyses and code that are missing from the manuscript: more rigorous IBD outcome definition, and analyses addressing the secondary analysis paragraph
 ***************************************/
