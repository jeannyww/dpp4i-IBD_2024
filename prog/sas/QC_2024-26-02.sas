/***************************************
SAS file name: QC_2024-26-02.sas

Purpose: Reviewing Zoey's QC of 017_dependencies.sas
Author: JHW
...
CHANGES:
Date: 2024-02-26
Notes: review of ZS QC de-identified
File of ZS QC in: D:\Externe Projekte\UNC\songz\prog\sas\qc.sas
***************************************/
...
%setup(programName=QC_2024-26-02, savelog=N, dataset=dataname);

/* Loading id's into program */
%include "D:\Externe Projekte\UNC\songz\prog\sas\idtmp.sas";

/*===================================*\
//SECTION - Zoey QC 
de-identified copy and paste of D:\Externe Projekte\UNC\songz\prog\sas\qc.sas
\*===================================*/
/* region */
...
/*%LET id=&id_x;*/
/*%LET id=&id_x; *SGLT only:  10AUG2012; */

%LET id=&id_x2; *SGLT only: 12AUG2013;
...
libname out 'D:\Externe Projekte\UNC\wangje\data\analysis' access=readonly;
libname temp 'D:\Externe Projekte\UNC\wangje\data\temp' access=readonly;
            libname raw  'D:\Externe Projekte\UNC\wangje\data\raw' access=readonly;
%LET id=&id_x2; *SGLT only: 12AUG2013;
