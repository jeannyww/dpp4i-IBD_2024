...
%macro setup ( programName , savelog , dataset);
      ...
      %let progpath = D:\Externe Projekte\UNC\wangje\prog\sas;
      ...
      /* Defining outpaths */
      %LET goutpath = &projdir.\out\;
      %LET toutpath = &projdir.\out\tables;
      %LET foutpath = &projdir.\out\figures;
      
      /* including formats */
      %include "&projdir.\prog\sas\formats\formats.sas";
